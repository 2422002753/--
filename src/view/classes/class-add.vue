    ...
    <div class="main">
      ...
      <div class="input_part"
        ...
        <span class="span_delete"
              @click="delete_current(index)">x</span>
      </div>
      <!-- 当删除了页面所有input框时 -->
      <div v-show="empty_showText"
           class="empty_showText">请添加一个班级 ! ~</div>
      ...
      <div class="btn">
        <div class="btn_div">
          <Button type="primary"
                  @click="add_class"
                  v-show="message.btn_current">添加班级</Button>
          <Button type="info"
                  v-show="message.btn_current"
                  @click="hide_current">添加多个</Button>
          <Button type="info"
                  v-show="!message.btn_current"
                  @click="add_class_data">增加班级</Button>
          <Button type="primary"
                  v-show="!message.btn_current"
                  @click="add_classList">添加所有</Button>
        </div>
      </div>
    </div>
    <!-- 添加多个时展示的信息部分 -->
